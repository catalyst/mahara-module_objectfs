...
$string['settings:batchsize'] = 'Maximum batch size';
$string['settings:batchsize_help'] = 'Maximum number of candidate objects to attempt to process in one run within the task run time.';
