...
use module_objectfs\object_manipulator\recoverer;

require_once(__DIR__ . '/classes/test_client.php');
require_once(__DIR__ . '/module_objectfs_testcase.php');

class recoverer_testcase extends module_objectfs_testcase {
    ...
    public function test_recoverer_will_recover_local_objects() {
        ...
        $DB->set_field('module_objectfs_objects', 'location', OBJECT_LOCATION_ERROR, array('contenthash' => $object->contenthash));
