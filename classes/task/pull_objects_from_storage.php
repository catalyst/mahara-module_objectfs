...
class pull_objects_from_storage extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return get_string('pull_objects_from_storage_task', 'module_objectfs');
    }
    ...
    public function execute() {
        manipulator::setup_and_run_object_manipulator('\\module_objectfs\\object_manipulator\\puller');
    }
}
